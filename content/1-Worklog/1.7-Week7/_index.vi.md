...
| :---: | :--- | :---: | :---: | :--- |
| **1** | Lên văn phòng công ty: Họp trực tiếp với team để khớp code Frontend/Backend. | | | |
| **2** | Lập trình Giao diện Phòng thi trực tuyến (Exam Room UI) với các tính năng chọn đáp án, chuyển câu hỏi mượt mà, lưu nháp bài làm và bộ đếm ngược thời gian. | | | |
| **3** | Tích hợp khung hiển thị camera (Webcam Stream) ngay góc màn hình phòng thi phục vụ cho tính năng giám sát AI (AI Proctoring), kết nối thử nghiệm luồng trả cảnh báo vi phạm từ backend. | | | |
