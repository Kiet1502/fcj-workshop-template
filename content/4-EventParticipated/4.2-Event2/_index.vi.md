---
title: "Event 2: Chung kết Cloud Architect & Seminar"
date: 2026-07-11
weight: 2
chapter: false
pre: " <b> 4.2. </b> "
...
# Bài thu hoạch sự kiện: Chung kết cuộc thi Cloud Architect & Seminar

### Thông tin tổng quan
- **Tên sự kiện:** Chung kết cuộc thi Cloud Architect & Seminar
- **Thời gian:** Thứ 7, ngày 11/07/2026
- **Vai trò:** Người tham dự

---

### Giới thiệu sự kiện
Sự kiện ngày 11/07 bao gồm 2 phần chính: phần thi đấu chung kết của cuộc thi Cloud Architect đầy kịch tính và 3 phần thuyết trình chuyên sâu từ 3 speaker khách mời. Đây là cơ hội tuyệt vời để học hỏi về các kiến trúc thực tế trên AWS, bảo mật ứng dụng, và các kinh nghiệm quý báu cho kỳ thi chứng chỉ.

---

### Nội dung các phần chia sẻ & Góc nhìn từ thực tế làm dự án

Sự kiện đã mang đến 3 bài thuyết trình rất bổ ích:
...
Sau sự kiện, em đã rút ra được nhiều bài học giá trị:
* **Áp dụng ngay vào đồ án nhóm:** Nắm được cách thiết lập bảo mật cơ bản và tư duy giám sát trải nghiệm người dùng cuối thay vì chỉ theo dõi CPU/Memory.
* **Kỹ năng mềm nghề nghiệp:** Cảm nhận được sức nóng của cuộc thi chung kết, từ đó tạo động lực hoàn thiện các kỹ năng cá nhân và làm việc nhóm hiệu quả hơn.
* **Mở rộng kết nối cộng đồng:** Có cơ hội học hỏi từ các chuyên gia giàu kinh nghiệm và hiểu rõ hơn về lộ trình chinh phục chứng chỉ AWS Cloud Practitioner.
